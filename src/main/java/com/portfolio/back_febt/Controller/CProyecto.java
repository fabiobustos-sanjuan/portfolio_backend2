...
import com.portfolio.back_febt.Dto.dtoProyecto;
import com.portfolio.back_febt.Entity.Proyecto;
import com.portfolio.back_febt.Security.Controller.Mensaje;
import com.portfolio.back_febt.Service.SProyecto;
...
public class CProyecto {
    ...
    public ResponseEntity<?> create(@RequestBody dtoProyecto dtoproyecto){
        ...
        Proyecto proyecto = new Proyecto(
            dtoproyecto.getNombreP(), dtoproyecto.getDescP(), dtoproyecto.getImgP()
            );
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoProyecto dtoproyecto){
        ...
        proyecto.setDescP(dtoproyecto.getDescP());
